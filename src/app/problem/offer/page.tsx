...
import OfferCodeEditor from "@/components/problem/offer/offer-code-editor";
import OfferProblemBar from "@/components/problem/offer/offer-problem-bar";
import OfferTestCaseBar from "@/components/problem/offer/offer-test-case-bar";
...
import { offerProblem } from "@/lib/fetchers/problem.fetchers";
...
const OfferProblem = () => {
  ...
  const handleSaveProblem = async () => {
    ...
    try {
      ...
      toastr.success("Problem offered successfully");
      router.push("/home");
    } catch (error) {
      toastr.error("Error offering problem");
      console.error("Error offering problem:", error);
    } finally {
      setCanSubmit(true);
    }
  };
