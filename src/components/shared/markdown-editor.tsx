...
const MarkdownEditor = ({ value, onChange, className = "", placeholder = "Write your Markdown here..." }: MarkdownEditorProps) => {
    ...
    return (
        <div className={`w-full h-full ${className} border-0 rounded-lg`} data-color-mode={resolvedTheme === 'dark' ? 'dark' : 'light'}>
            <MDEditor
                value={internalValue}
