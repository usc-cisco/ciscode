...
const CodeEditor: React.FC<CodeEditorProps> = ({ onCodeChange, code, handleReset }) => {
    ...
    <ProblemCard className='overflow-hidden relative'>
      ...
      <HoverCard>
        <HoverCardTrigger className='absolute bottom-4 right-6'>
          <Button onClick={handleReset} className='rounded-full size-12 flex justify-center items-center opacity-50 hover:opacity-100 transition-opacity cursor-pointer'>
