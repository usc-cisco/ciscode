...
const CodeEditor: React.FC<CodeEditorProps> = ({
  ...
  return (
    <ProblemCard className="flex flex-col h-full relative">
      <div className="shrink-0 px-2 py-2 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center bg-vscode-light dark:bg-vscode-dark rounded-t-2xl sticky top-0 z-10">
