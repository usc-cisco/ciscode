    ...
    >
      ...
      {checking ? (
        ...
        <button
          ...
          className={`absolute top-4 right-2 rounded-full flex items-center justify-center border border-primary size-6 hover:bg-blue-100 dark:hover:bg-blue-900 cursor-pointer transition-colors ${sending && "pointer-events-none opacity-50"}`}
        >
          ...
          {testCase.status === TestCaseSubmissionStatusEnum.FAILED && (
            <Dialog>
              ...
              <DialogContent className="bg-vscode-light dark:bg-vscode-dark">
                ...
                <Info
                  text="The actual output must match the expected output exactly."
                  className="mt-2"
                />
              </DialogContent>
            </Dialog>
