...
import OfferTestCase from "./offer-test-case";
import { RunCodeResponseType } from "@/dtos/code.dto";

interface OfferTestCaseBarProps {
...
const OfferTestCaseBar: React.FC<OfferTestCaseBarProps> = ({
  testCases,
  onAddTestCase,
  onTestCaseChange,
  onDeleteTestCase,
  ...
  return (
    <ProblemCard className="relative overflow-hidden">
      ...
      <div className="max-h-full overflow-auto pb-26">
        <p className="text-[0.65rem] text-center mt-2 text-gray-400 dark:text-gray-600">
          Please check all test cases before submitting
        </p>
      ...
      <div className="px-4 h-14 absolute bottom-0 w-full border-t border-gray-200 dark:border-gray-700 flex justify-center items-center bg-vscode-light dark:bg-vscode-dark">
        <Button
          className="w-full bg-primary py-2 rounded-lg cursor-pointer"
...
export default OfferTestCaseBar;
